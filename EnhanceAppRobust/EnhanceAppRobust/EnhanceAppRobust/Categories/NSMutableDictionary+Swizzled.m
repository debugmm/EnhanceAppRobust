...
+(void)initConfigInstanceMethodSwizzle{
    ...
    [NSMutableDictionary exchangeClassInstanceMethod:class originalSelector:@selector(setObject:forKey:) swizzledSelector:@selector(zz_setObject:forKey:)];
    
    [NSMutableDictionary exchangeClassInstanceMethod:class originalSelector:@selector(setObject:forKeyedSubscript:) swizzledSelector:@selector(zz_setObject:forKeyedSubscript:)];
    
    [NSMutableDictionary exchangeClassInstanceMethod:class originalSelector:@selector(removeObjectForKey:) swizzledSelector:@selector(zz_removeObjectForKey:)];
}
